<head>
	...
	$consulta="SELECT SQL_CALC_FOUND_ROWS * FROM inventario where Tipo_producto ='Polines' LIMIT $offset, $maximosRenglones";
   ...
   <tbody>
      <?php
         ...
         <tr>
            ...
            <td>$<?php echo $Precio_compra; ?>.00</td>
            <td>$<?php echo $Precio_venta; ?>.00</td>
